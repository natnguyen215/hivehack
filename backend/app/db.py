...
def get_fire_polygon(timestamp: str) -> dict | None:
    """
    Return a GeoJSON Feature dict for the fire perimeter at the given timestamp.
    Returns None if no fire data exists for that timestamp.
